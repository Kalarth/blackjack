...
var ImageBanque = function() {
  ...
  var sep_ini_banque=ini_banque.split('.');
  x_ini_banque=sep_ini_banque[0]
  valeur_ini_banque = x_ini_banque%13
...
var ajoutImgDansDiv = function () {
    ...
    ChangementScore(chemin);
}

var ChangementScore = function(chemin){
